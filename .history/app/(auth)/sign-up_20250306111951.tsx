      ...
      {role === "farmer" && (
        <View>
          <Controller
            ...
            name="farmSize"
            render={({ field }) => (
              <TextInput {...field} placeholder="Farm Size (in acres)" className="border p-3 rounded mt-4" />
            )}
          />
          {errors.farmSize && <Text className="text-red-500">{errors.farmSize.message}</Text>}

          <Controller
            control={control}
            name="cropType"
            render={({ field }) => (
              <TextInput {...field} placeholder="Type of Crops Grown" className="border p-3 rounded mt-4" />
            )}
          />
          {errors.cropType && <Text className="text-red-500">{errors.cropType.message}</Text>}
