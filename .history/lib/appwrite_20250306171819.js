import {
  ...
  export const getOrders = async (userId: string, role: "consumer" | "farmer") => {
    try {
      const response = await databases.listDocuments(
        "farmnation_db",  // Database ID
        "orders",         // Orders Collection ID
        [
          role === "consumer"
            ? { key: "userId", value: userId }    // Fetch orders placed by the consumer
            : { key: "farmerId", value: userId }  // Fetch orders assigned to the farmer
        ]
      );
