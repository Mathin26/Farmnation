...
const ProductCard = ({ product }: { product: Product }) => {
  return (
    <View className="flex flex-col bg-white p-4 rounded-2xl shadow-lg w-48 mx-2 border border-secondary-200">
      <Image
      ...
      <TouchableOpacity className="bg-primary-200 p-2 rounded-lg mt-3">
